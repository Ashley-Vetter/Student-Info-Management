...
namespace Student_Information_Management.Presentation_Layer
{
    public partial class Delete : Form
    {
        ...
        {
            handler.deleteStudent(int.Parse(btnDelStu.Text));//calls a method and deletes student info on click
        }

        private void btnDelMod_Click(object sender, EventArgs e)
        {
            handler.deleteModule(int.Parse(btnDelMod.Text));//calls a method and deletes module info on click
        }
    }
}
